...
if (empty($action)) {
	...
	<div class='contact-content'>
		<div class='instructions'>
			<h1>Record a short video.</h1>
			<ul>
				<li>If you have a webcam, you can use YouTube to <a href='http://upload.youtube.com/my_videos_upload' alt='Record from webcam'>record from a webcam</a>.</li>
				<li>What to say:  1. Say your name  2. Where you are from  3. Your connection with Michigan Engineering  4. Describe a special holiday memory or tradition from your family or culture.	</li>
	...
	if ($token === smcf_token($to)) {
		smcf_send($name, $location, $youtube, $message, $email);
...
function smcf_send($name, $location, $youtube, $message, $email) {
	global $to, $extra;
	...
	$message .= "\n\nYoutube URL: $youtube.  Name: $name.  Email: $email";
