...
--
-- Host: localhost
-- Generation Time: Nov 09, 2012 at 09:04 PM
...
INSERT INTO `pages` (`id`, `title`, `imgsrc`, `media`, `category`, `subcategory`, `paragraph`) VALUES
(1, 'Meet Ashley Godin', 'img/scroll/scroll1.png', '<img src="img/checked.png" alt="ashley godin" />', 'next', 'meet some students', '<p><b>Hometown</b><br />\nMidlothian, IL<br />\n<b>Department</b><br />\nBiomedical Engineering<br />\n<b>Expected Graduation</b><br />\nApril 2015<br /></p>\n<p>Ashley is a living, breathing example of synthesis. Ever since childhood, she’s exhibited the melding of two halves: her father''s "problem-solving perfectionism" and her mother''s "organized yet down-to-earth" attitude. The natural middle-ground is a "highly-caffeinated" student who loves academics, math and science – and blasting Blink-182 in the car.\n</p>'),
(2, 'Meet Hannah Cheriyan', 'img/scroll/scroll1.png', '<img src="img/checked.png" alt="ashley godin" />', 'next', 'meet some students', '<p>Some Content here</p>'),
(3, 'Checklist of admissions tasks', 'img/scroll/scroll1.png', '', 'next', 'next steps', '<p>Your Admissions Checklist includes the list of task needed to enroll at Michigan Engineering. Click each box to check when complete.</p>\n                <form id="checklist">\n                	<div><input class="styled" id="c1" type="checkbox" name="step1" value="1" onclick="checkthis(''c1'')"/><p><span class="steps" id="c1p">STEP ONE</span><br />Receive your acceptance letter and view admitted student website.</p></div>\n                	<div><input class="styled" id="c2" type="checkbox" name="step2" value="2" onclick="checkthis(''c2'')"/><p><span class="steps" id="c2p">STEP TWO</span><br />Submit $200 application deposit. The deposit can be paid via credit card or check. If paying by check, make payable to the University of Michigan College of Engineering and mail to 1000 University Ave, Suite 3A, Ann Arbor, MI 48108</p></div>\n                	<div><input class="styled" id="c3" type="checkbox" name="step3" value="3" onclick="checkthis(''c3'')"/><p><span class="steps" id="c3p">STEP THREE</span><br />Receive your acceptance letter and view admitted student website.</p></div>\n                </form>\n<script>load_checklist();</script>');
