<?php
	...
	while ($row = mysql_fetch_assoc($result)){
		...
		$query2 = "SELECT * FROM holidays WHERE (department LIKE '%$department_id%') ORDER BY id";
		echo("<!--$query2-->");
	...
	while ($row = mysql_fetch_assoc($result)){
		...
		$query2 = "SELECT * FROM holidays WHERE (grp LIKE '%$group_id%') ORDER BY id";
		echo("<!--$query2-->");
		$result2 = mysql_query($query2);
	...
	$query = "SELECT * FROM holidays WHERE (name LIKE '%$q%') ORDER BY id";
	$result = mysql_query($query);
	while ($row = mysql_fetch_assoc($result)){
