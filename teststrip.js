...
var umcoe = {
    init: function () {
        ...
        var count = index+1;
        $(this).append("<div class='play-button-videostrip'><span style='opacity: 0; text-indent: -9999px;'>"+count+"</span></div>");
        });
        $(".c1Image img").remove();
        // /videostrip
        ...
        $(".youtubeColorbox").each(function(index, element) {
            ...
            $("#div-"+$(this).attr("id")).append("<div class='play-button-videoportlet'><div class=\"youtube-title\"></div></div>");
        ...
        // Trim length of title in Video Portlets.
        if ($(".promoHolderYoutube").length) {
            umcoe.trimString(".promoHolderYoutube .youtube-title h3", 40);
        }
