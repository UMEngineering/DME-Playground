...
$(document).ready(function(e) {
	...
	if (width >= 450) {
		...
		// Initialize the html/css, remove the desktop left part, and show the mobile left part
		$(".desktop-left").hide();
		$(".mobile-left").show();
		$(".items").css({"left" : "0", "overflow-y" : "auto", "width" : width_mobile + "px"});
		$(".itemcontainer").css({"width" : width_mobile + "px"});
		
		// Insert Flexslider css
