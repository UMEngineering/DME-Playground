...
(function ( document, window ) {
    ...
    var impress = window.impress = function ( rootId ) {
        ...
        var initStep = function ( el, idx ) {
			...
			var temp = document.getElementById(el.id);
			temp = temp.getElementsByTagName("iframe")[0];
			if (temp) {
				console.log("Deal with an iFrame");				
				css(temp, {
					position: "relative",
        ...
        var goto = function ( el, duration ) {
			...
			//******BEN'S EDIT: Associate other elements.******* 			
			...
			if ( litCache.length != 0 ){
				for (var k in litCache){
					console.log("litCache", litCache[k]);
