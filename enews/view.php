            ...
            <table width="480" cellspacing="0" cellpadding="0" border="0">
                <tbody>
                    <tr>
                        ...
                        <p><a target="_blank" href="<?= $row[4] ?>" style="color: #003366"><img width="480" border="0" title="<?= $row[0] ?>" src="http://engcomm.engin.umich.edu/enews/<?= $row[1] ?>" alt="<?= $row[6] ?>" /></a></p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        &nbsp;<br />
                        <strong><a target="_blank" href="<?= $row[4] ?>" style="color: #6B4E01; text-decoration:none"><?= $row[0] ?></a></strong></p>
                        <p style="font-size: 14px; margin: 0pt 0pt 0pt 0pt; color: #003366; line-height: 20px; "><?= $row[3] ?></p>
                        <a target="_blank" style="text-decoration: none;font-size: 10px; letter-spacing: 1pt; color:#9DACCE; font-family: Palatino, 'Palatino Linotype', 'Book Antiqua', serif; line-height: 20px; display: block; margin-top: 8px;" href="<?= $row[4] ?>">VIEW THIS DIGITAL MULTIMEDIA EXPERIENCE</a></td>
                    </tr>
                    <tr>
                        <td valign="top">
                        <table width="472" cellspacing="0" cellpadding="0" style="font-size: 12px; font-family: Arial,Helvetica,sans-serif">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <p><a target="_blank" href="<?= $row[4] ?>" style="color: #003366"><img width="100" height="100" border="0" src="http://engcomm.engin.umich.edu/enews/<?= $row[1] ?>" title="<?= $row[0] ?>" alt="<?= $row[6] ?>" /></a></p>
                                    </td>
                                    ...
                                    <p style="line-height: 22px; font-size: 14px; margin: 0pt 0pt; color:#6B4E01; font-family: Palatino, 'Palatino Linotype', 'Book Antiqua', serif"><a target="_blank" href="<?= $row[4] ?>" style="color: #6B4E01; text-decoration:none"><strong><?= $row[0] ?></strong></a></p>
                        ...
                        <table width="134" cellspacing="0" cellpadding="0" style="padding-right: 0pt; padding-left: 0pt; font-size: 12px; padding-bottom: 0pt; padding-top: 10px; font-family: Arial,Helvetica,sans-serif">
                            <tbody>
                                <tr>
                                    ...
                                    <a target="_blank" href="http://mconnex.engin.umich.edu/"><img title="link to MconneX" longdesc="image link to MconneX page" alt="Link to MconneX" src="http://engcomm.engin.umich.edu/august_enews/img/mconnexbadge.jpg" style="border-right: none; border-top: none; border-left: none; border-bottom:thin; border-bottom-color:#D8DFEA  " /></a><br />
