	...
	<div id="content">
        ...
        <form method="POST" action="process.php" enctype="multipart/form-data">
            ...
            <div class="big-entry">
                ...
                <p><label>Image: </label><input type="text" name="image-big" id="image-big" size="78"/></p>
                <p><label>Upload image: </label><input type="file" name="file[]" /></p>
                <p><label>Alt text for image: </label><input type="text" name="alt-big" id="alt-big" size="65"/></p>
