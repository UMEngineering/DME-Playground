    ...
    init: function () {
        ...
        if ($(document.body).hasClass("portaltype-uom-pfiles-profile")) {
          ...
          // Adds profile tabs and ARIA for tabs
            ...
            $("div#content div.promoHolderProfiles span.profilesMichEng").fadeTo(3500,0.75).fadeOut(1500);  

      

        // Setup videostrip images - ticket 1251.
        $(".video_strip .c1Image").each(function(index, element) {
        ...
        // End videostrip image setup.


        // Build video portlet - ticket #1291
          var $ytColorbox = $(".youtubeColorbox");

          // Loop over all the video portlets
            $ytColorbox.each(function (index, element) {
    ...
    setupCarousels: function (selector, numToShow) {
        ...
        $selector.find("li a").click(function (e) {
            ...
            $("." + $this.attr("class")).colorbox({
               ...
               width: "748",
               loop: false,
               current: "Image {current} of {total}" // Capitalize the word 'image' - ticket #1303.
            });
