...
<body>
  ...
  <div id="container">
	...
	<a href="http://engin.umich.edu/" id="home"  alt="Michigan Engineering Home "><img id="logo" src="img/logo.png" /></a>
    ...
    <form method="post" action="" name="search" id="search">
         <input style="width: 240px;color: #cccccc;" value="Search by name, group, or department." type="text" name="q" />
   		...
   		<div id="globe">
        <img id="hh_base" src="img/HH_Base_PV.png" align="center" />
        ...
        <img id="hh_top" src="img/HH_Top_PV.png" />
